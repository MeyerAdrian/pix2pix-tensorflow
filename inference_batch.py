...
def local_inference(input_model, input_dir, output_dir, use_sbs, input_dir_label, output_dir_sbs, res, *args):
    ...
    with tf.Session(config=config) as sess:
        ...
        for i in os.listdir(input_dir):
            ...
            if (int(use_sbs) == 1):
                ...
                import merge_sbs
                merge_sbs.merge_abc_sbs(input_dir, input_dir_label, output_dir, output_dir_sbs)
